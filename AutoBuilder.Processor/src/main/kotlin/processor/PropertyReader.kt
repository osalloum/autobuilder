...
class PropertyReader(
    ...
    private val defaultAnnotations = mapOf<String, (KSAnnotation, KSPropertyDeclaration, Resolver) -> String>(
        qualifiedAnnotation("DefaultInt") to ::readIntDefault,
        qualifiedAnnotation("DefaultLong") to ::readLongDefault,
        qualifiedAnnotation("DefaultFloat") to ::readFloatDefault,
        qualifiedAnnotation("DefaultDouble") to ::readDoubleDefault,
        qualifiedAnnotation("DefaultBoolean") to ::readBooleanDefault,
        qualifiedAnnotation("DefaultChar") to ::readCharDefault,
        qualifiedAnnotation("DefaultByte") to ::readByteDefault,
        qualifiedAnnotation("DefaultShort") to ::readShortDefault,
        qualifiedAnnotation("DefaultString") to ::readStringDefault
    )
